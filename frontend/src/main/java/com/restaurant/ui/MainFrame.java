...
public class MainFrame extends JFrame {
    ...
    private String[]  navPages = {"home", "menu", "ban", "nhanvien", "donhang", "chedomlamviec"};
    private String[]  navLabels = {"🏠 Home", "Menu", "Bàn", "Nhân viên", "Đơn hàng", "Chế độ làm việc"};
    ...
    private void buildUI() {
        ...
        contentArea.add(buildPlaceholder("Chế độ làm việc"), "chedomlamviec");
    ...
    private JPanel buildHeader() {
        ...
        globe.setFont(new Font("Segoe UI Emoji", Font.PLAIN, 18));
        globe.setForeground(UIConstants.PRIMARY);
        JLabel restName = new JLabel("Tên nhà hàng");
        restName.setFont(UIConstants.FONT_LOGO);
        restName.setForeground(UIConstants.PRIMARY);
        right.add(globe);
        right.add(restName);
    ...
    private JPanel buildNavBar() {
        ...
        btnLogout.addActionListener(e -> {
            int r = JOptionPane.showConfirmDialog(this, "Bạn có muốn đăng xuất?",
                "Xác nhận", JOptionPane.YES_NO_OPTION);
            if (r == JOptionPane.YES_OPTION) {
                com.restaurant.data.ApiClient.getInstance().logout();
                dispose();
                // Hiện lại màn hình login
                com.restaurant.ui.LoginDialog loginDialog = new LoginDialog(null);
